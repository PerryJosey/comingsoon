/*
*	Woody - Coming Soon & Under Construction Hugo Theme
*	Version: 1.0.0
*	Author: Mountain-Themes
*	Author URL: https://themeforest.net/user/mountain-themes
*	Woody © 2022. Design & Coded by Mountain-Themes.
*/
...
/* ================================= */
	...
	setTimeout(function() {
		$(".coming-soon .header-section .social-icons").delay(1200).css({display: 'none'}).fadeIn(1200);
		$(".coming-soon .header-section .mouse-wrapper").delay(1500).css({display: 'none'}).fadeIn(1500);
		$(".coming-soon .header-section .countdown").delay(1200).css({display: 'none'}).fadeIn(1200);
		$(".coming-soon .header-section h1").delay(1200).css({display: 'none'}).fadeIn(1200);
		$(".coming-soon .header-section p").delay(1200).css({display: 'none'}).fadeIn(1200);
		$(".coming-soon .header-section .logo img").delay(1200).css({display: 'none'}).fadeIn(1200);
	  });
